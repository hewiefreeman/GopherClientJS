...
GopherVoiceChat.prototype.rD=function(a){var c=this;void 0==this.mList[a.u]&&(blobFromText=new Blob([convertDataURIToBinary(a.d)],{type:"audio/webm;codecs=opus"}),50>=blobFromText.size||this.getBlobDuration(blobFromText).then(function(a){var b=new FileReader;b.onloadend=function(){c.acO.decodeAudioData(b.result).then(function(b){var d=c.acO.createBufferSource();d.buffer=b;b=c.acO.createGain();b.gain.value=c.volume;d.connect(b);b.connect(c.acO.destination);b.gain.setValueAtTime(.01,0);b.gain.exponentialRampToValueAtTime(c.volume,
.005);b.gain.setValueAtTime(c.volume,a-.005);b.gain.exponentialRampToValueAtTime(.01,a);d.start()})["catch"](function(a){console.log("[gopherChat.voiceChat] Error decoding voice stream data")})};b.readAsArrayBuffer(blobFromText)}))};GopherVoiceChat.prototype.pD=function(){var a=100*(performance.now()-this.pT);this.vcPing=(this.vcPing+a)/2};var BASE64_MARKER=";base64,";
