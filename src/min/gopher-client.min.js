...
function GopherServerClient(){this.browserVoiceSupport=!1;this.voiceChat=null;if(!window.WebSocket)return null;navigator.mediaDevices.getUserMedia&&(this.browserVoiceSupport=!0,this.voiceChat=new GopherVoiceChat);this.ip="";this.port=0;this.socketURL="";this.ssl=!1;this.socket=null;this.guest=this.rememberMe=this.loggedIn=this.connected=!1;this.roomName=this.userName="";this.status=0;this.friends={};this.userVars={};this.clientActionDefs={signup:"s",deleteAccount:"d",changePassword:"pc",changeAccountInfo:"ic",
login:"li",logout:"lo",joinRoom:"j",leaveRoom:"lr",createRoom:"r",deleteRoom:"rd",roomInvite:"i",revokeInvite:"ri",chatMessage:"c",privateMessage:"p",voiceStream:"v",changeStatus:"sc",customAction:"a",requestFriend:"f",acceptFriend:"fa",declineFriend:"fd",removeFriend:"fr",setUserVariable:"vs",setUserVariables:"vx"};this.messageTypes={CHAT:0,PRIVATE:1,SERVER:2};this.serverMessageTypes={GAME:0,NOTICE:1,IMPORTANT:2};this.serverMessageNames=["Game","Notice","Important"];this.userStatuses={available:0,
inGame:1,idle:2,offline:3};this.userStatusDefs=["Available","In Game","Idle","Offline"];this.friendStatusDefs={requested:0,pending:1,accepted:2};this.events={signup:"onsignup",accountDelete:"onaccountdelete",passwordChange:"onpasswordchange",accountInfoChange:"onaccountinfochange",autologInit:"onautologinit",autologFailed:"onautologfailed",autologNoFile:"onautolognofile",login:"onlogin",logout:"onlogout",connected:"onconnect",disconnected:"ondisconnect",joined:"onjoinroom",left:"onleaveroom",userJoined:"onuserjoin",
userLeft:"onuserleft",roomCreate:"oncreateroom",roomDelete:"ondeleteroom",invited:"oninvite",inviteRevoked:"onrevokeinvite",inviteReceived:"oninvitereceived",chatMessage:"onchatmessage",privateMessage:"onprivatemessage",serverMessage:"onservermessage",data:"ondata",statusChanged:"onstatuschanged",customAction:"oncustomaction",friendRequested:"onfriendrequested",friendAccepted:"onfriendaccepted",friendDeclined:"onfrienddecline",friendRemoved:"onfriendremove",friendRequestReceived:"onfriendrequestreceived",
friendRequestAccepted:"onfriendrequestaccepted",friendStatusChanged:"onfriendstatuschanged"};this.onFriendStatusChangeListener=this.onFriendRequestAcceptedListener=this.onFriendRequestRecievedListener=this.onRemoveFriendListener=this.onDeclineFriendListener=this.onAcceptFriendListener=this.onRequestFriendListener=this.onCustomActionListener=this.onStatusChangeListener=this.onDataListener=this.onServerMsgListener=this.onPrivateMsgListener=this.onChatMsgListener=this.onRecieveInviteListener=this.onRevokeListener=
this.onInviteListener=this.onDeleteRoomListener=this.onCreateRoomListener=this.onUserLeaveListener=this.onUserJoinListener=this.onLeaveRoomListener=this.onJoinRoomListener=this.onDisconnectListener=this.onConnectListener=this.onLogoutListener=this.onLoginListener=this.onAutoLogNoFileListener=this.onAutoLogFailListener=this.onAutoLogInitListener=this.onAccountInfoChangeListener=this.onPasswordChangeListener=this.onAccountDeleteListener=this.onSignupListener=null;this.paramError="An incorrect parameter type was supplied";
return!0}GopherServerClient.prototype.connect=function(a,b,c){if(a.constructor!=String||b.constructor!=Number||c.constructor!=Boolean)return this.paramError;this.ip=a;this.port=b;this.ssl=c;this.socketURL=1==c?"wss://"+a+":"+b+"/wss":"ws://"+a+":"+b+"/ws";this.socket=new WebSocket(this.socketURL);this.socket.addEventListener("open",this.sO);this.socket.addEventListener("close",this.sD);this.socket.addEventListener("message",this.sR)};GopherServerClient.prototype.disconnect=function(){this.socket.close()};
GopherServerClient.prototype.sO=function(a){a=gopherClient;a.connected=!0;if(null!=a.onConnectListener)a.onConnectListener()};GopherServerClient.prototype.sD=function(a){a=gopherClient;a.socket.removeEventListener("open",a.sO);a.socket.removeEventListener("close",a.sD);a.socket.removeEventListener("message",a.sR);a.connected=!1;a.loggedIn=!1;a.rememberMe=!1;a.guest=!1;a.userName="";a.roomName="";a.status=0;a.friends={};if(null!=a.onDisconnectListener)a.onDisconnectListener()};
GopherServerClient.prototype.sR=function(a){a=JSON.parse(a.data);gopherClient.sRhandle(a)};
...
this.createRoomResponse(a.c):a.c.a==this.clientActionDefs.roomInvite?this.sendInviteResponse(a.c):a.c.a==this.clientActionDefs.revokeInvite?this.revokeInviteResponse(a.c):a.c.a==this.clientActionDefs.deleteRoom?this.deleteRoomResponse(a.c):a.c.a==this.clientActionDefs.requestFriend?this.requestFriendRecieved(a.c):a.c.a==this.clientActionDefs.acceptFriend?this.acceptFriendRecieved(a.c):a.c.a==this.clientActionDefs.declineFriend?this.declineFriendRecieved(a.c):a.c.a==this.clientActionDefs.removeFriend?
this.removeFriendRecieved(a.c):a.c.a==this.clientActionDefs.changeStatus&&this.changeStatusRecieved(a.c);else if(void 0!==a.e){if(null!=this.onUserJoinListener)this.onUserJoinListener(a.e.u,a.e.g)}else if(void 0!==a.x){if(null!=this.onUserLeaveListener)this.onUserLeaveListener(a.x.u)}else if(void 0!==a.m)if(void 0!==a.m.s){if(null!=this.onServerMsgListener)this.onServerMsgListener(a.m.s,a.m.m)}else{if(null!=this.onChatMsgListener)this.onChatMsgListener(a.m.a,a.m.m)}else if(void 0!==a.p){if(null!=
this.onPrivateMsgListener)this.onPrivateMsgListener(a.p.f,a.p.t,a.p.m)}else if(void 0!==a.i){if(null!=this.onRecieveInviteListener)this.onRecieveInviteListener(a.i.u,a.i.r)}else if(void 0!==a.f){if(this.friends[a.f.n]={name:a.f.n,requestStatus:this.friendStatusDefs.requested,status:-1},null!=this.onFriendRequestRecievedListener)this.onFriendRequestRecievedListener(a.f.n)}else if(void 0!==a.fa){if(void 0!=this.friends[a.fa.n]?(this.friends[a.fa.n].requestStatus=this.friendStatusDefs.accepted,this.friends[a.fa.n].status=
...
GopherServerClient.prototype.declineFriendRecieved=function(a){if(void 0!==a.e){if(null!=this.onDeclineFriendListener)this.onDeclineFriendListener("",a.e)}else{if(null!=this.onDeclineFriendListener)this.onDeclineFriendListener(a.r,null);void 0!=this.friends[a.r]&&delete this.friends[a.r]}};
